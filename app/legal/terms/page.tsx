          ...
          <CardContent className="prose prose-invert max-w-none space-y-6">
            <section className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                By accessing and using RH, you accept and agree to be bound by these Terms of Service. If you
            ...
            <section className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                You agree to use RH only for lawful purposes and in accordance with these Terms. You are
            ...
            <section className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                The content you create using RH belongs to you. However, you grant us a license to use,
            ...
            <section className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                RH is provided as-is without warranties of any kind. We are not liable for any damages arising
            ...
            <section className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                new Terms on this page. Your continued use of RH after changes constitutes acceptance of the
                new Terms.
              </p>
            </section>
          </CardContent>
